    ...
    fetch(translations[language])
      ...
      .then((data) => {
        ...
        document.getElementById("projectHeadingBackground").textContent =
          ...
          document.getElementById("projectNeeds").textContent =
          data.projectNeeds;
        ...
        document.getElementById("projectUserFlowDecision").textContent =
          ...
          document.getElementById("projectAccent").textContent =
          data.projectAccent;
          document.getElementById("projectBlack").textContent =
          data.projectBlack;
          document.getElementById("projectWhite").textContent =
          data.projectWhite;
